...
let transporter = nodemailer.createTransport({
  ...
  secure: false,
  auth: {
    user: "mmitul98@gmail.com",
    pass: "cckvvchredqzajnb",
  },
});
mongoose
      ...
      if(name1.test(uname) && email1.test(email) && pass1.test(password)) {
        ...
        userModel
          ...
          .then((data) => {
           ...
           res.render("upload", {
          errmsg: "",
          succmsg:"You have been sucessfully registered. Kindly check your mail for activation link.",
        });
          })
          .catch((err) => {
